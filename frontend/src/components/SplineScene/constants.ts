...
export const UFO_BLOCK_HIDE_X_THRESHOLD = 2; // X position threshold for hiding blocks above UFO (in scene coordinates)
...
export const HIDE_Y_BASE_OFFSET = 0; // Base Y offset for hiding calculations
